  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-gray-900 p-4 sm:p-6 rounded-lg w-full max-w-sm md:w-2/3 lg:w-1/2 overflow-y-auto">
        <h2 className="text-xl sm:text-2xl mb-4 text-white">Edit Workout</h2>
        <form>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block text-sm sm:text-base mb-2 text-gray-200">Duration (mins)</label>
            <input
              type="number"
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-2 mt-4">
            ...
            <button
              type="button"
              className="w-full sm:w-auto btn btn-danger bg-rose-600 hover:bg-rose-600/80 transition-transform duration-300 hover:scale-105 px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base rounded-md"
